/// State extensions and builders for NID OCR state management
///
/// This file provides convenience extensions and builder widgets for
/// easy access to OCR state and controller throughout the widget tree.
library;
